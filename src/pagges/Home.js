        ...
        <>
          <section className="p-8 max-w-7xl mx-auto">
            <div className="text-center">
              <h1 className="flex items-center justify-center text-center px-3 text-3xl font-bold lg:text-5xl text-black">
                The Dog App
              </h1>
              <form
              ...
              >
                <input
                  ...
                  className="py-2 px-4 rounded shadow w-full bg-slate-400 text-black placeholder-black"
                  value={text}
